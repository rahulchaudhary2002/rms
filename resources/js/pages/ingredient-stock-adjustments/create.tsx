...
export default function IngredientStockAdjustmentsCreate({ warehouses, defaultWarehouseId, ingredients, stockByIngredient }: Props) {
    ...
    return (
        <>
            ...
            <PageHeader
                ...
                description="Correct discrepancies between system and actual stock quantities."
            />

            <form onSubmit={submit} className="space-y-8 pb-6">
                <FormSection title="Adjustment Details" description="Select the warehouse and date for this adjustment.">
                ...
                <FormSection
                    title="Items"
                    description="Enter the actual physical count for each ingredient. System quantity is read from current stock."
                >
                ...
                <div className="flex flex-wrap items-center justify-end gap-4 border-t border-border/70 pt-8 dark:border-stone-700">
                    ...
                    <Link href={adjustmentsIndex.url()} className="rounded-lg px-6 py-2.5 text-sm font-semibold text-muted-foreground transition-colors hover:bg-secondary">
                        Discard
                    </Link>
                    <button
                        type="submit"
