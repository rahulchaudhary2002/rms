...
export default function FoodRecipeEdit({ recipe, foods, ingredients, units }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        food_id: String(recipe.food_id),
        food_variant_id: recipe.food_variant_id ? String(recipe.food_variant_id) : '',
    ...
    return (
        <>
            ...
            <PageHeader
                ...
                description={recipe.food?.name ?? 'Update this food recipe line.'}
            />

            <form onSubmit={submit} className="space-y-8 pb-6">
                <FormSection title="Recipe Line" description="Update the food, ingredient, usage unit, and quantity.">
