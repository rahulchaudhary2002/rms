...
import type { Ingredient, PurchaseInvoice, PurchaseOrder, PurchaseReceive, Supplier, Unit } from '@/types';
...
export default function PurchaseInvoicesEdit({ invoice, suppliers, purchaseOrders, purchaseReceives, ingredients }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        purchase_receive_id: invoice.purchase_receive_id ? String(invoice.purchase_receive_id) : '',
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        put(invoicesUpdate.url(invoice), { preserveScroll: true });
    }
        ...
        <>
            ...
            <PageHeader
                    breadcrumbs={[
                        ...
                        { label: invoice.invoice_no, href: invoicesShow.url(invoice) },
                        { label: 'Edit' },
                    ]}
                ...
                <form onSubmit={submit} className="space-y-8 pb-6">
                    <FormSection title="Invoice Details" description="Modify supplier invoice information and dates.">
                    ...
                    <FormSection title="Invoice Items" description="Update invoiced items with quantities and amounts.">
                    ...
                    <div className="flex flex-wrap items-center justify-end gap-4 border-t border-border/70 pt-8 dark:border-stone-700">
                        ...
                        <Link href={invoicesShow.url(invoice)} className="rounded-lg px-6 py-2.5 text-sm font-semibold text-muted-foreground transition-colors hover:bg-secondary">
                            Discard Changes
                        </Link>
