...
import { index as ingredientsIndex, update as ingredientsUpdate } from '@/routes/ingredients';
...
export default function IngredientsEdit({ ingredient, categories, units }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ingredient_category_id:   ingredient.ingredient_category_id !== null ? String(ingredient.ingredient_category_id) : '',
        name:                     ingredient.name,
        slug:                     ingredient.slug,
        code:                     ingredient.code,
        barcode:                  ingredient.barcode ?? '',
        base_unit_id:             String(ingredient.base_unit_id),
        default_purchase_unit_id: ingredient.default_purchase_unit_id !== null ? String(ingredient.default_purchase_unit_id) : '',
        default_usage_unit_id:    ingredient.default_usage_unit_id !== null ? String(ingredient.default_usage_unit_id) : '',
        ...
        <>
            ...
            <PageHeader
                breadcrumbs={[
                    ...
                    { label: 'Inventory', href: ingredientsIndex.url() },
