...
export default function LoyaltyPointRulesCreate({ scopeOutlets, scopeType, scopeOutletId }: Props) {
    const scopeLocked = scopeType !== 'global';
    const defaultType = scopeType === 'outlet' ? 'outlet' : 'global';

    const { data, setData, post, processing, errors } = useForm({
        name: '',
        type: defaultType as 'global' | 'outlet' | 'campaign',
        outlet_id: scopeOutletId ? String(scopeOutletId) : '',
        earning_type: 'fixed_rate' as 'fixed_rate' | 'fixed_slab',
        earn_amount: '',
        earn_points: '',
        slabs: [] as SlabRow[],
        redeem_point_value: '1',
    ...
    return (
        <>
            <Head title="Create Loyalty Point Rule" />
            <PageHeader
                breadcrumbs={[
                ...
                title="Create Loyalty Point Rule"
                description="Define a new earning and redemption rule for loyalty points."
            />
